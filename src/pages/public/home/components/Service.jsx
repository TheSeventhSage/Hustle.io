...
export function ServicesGridSection() {
    ...
    const DUMMY_SERVICES = [
        ...
        { id: 'd2', image: "https://images.unsplash.com/photo-1531384441138-2736e62e0919?auto=format&fit=crop&q=80&w=600", title: "Luxury Brand Architecture", price: "1,800", rating: 5.0, author: "Studio Gold" },
        { id: 'd3', image: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&q=80&w=600", title: "Financial Modeling & Strategy", price: "3,200", rating: 4.9, author: "Elena Tech" },
        { id: 'd4', image: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&q=80&w=600", title: "Corporate Legal Structuring", price: "1,500", rating: 4.8, author: "Legal Flow" },
    ];
    ...
    return (
        <section className="py-24 bg-white dark:bg-surface max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                ...
                <Button variant="outline" className="w-auto px-6 border-[var(--color-primary-300)] text-[var(--color-primary-300)]">
