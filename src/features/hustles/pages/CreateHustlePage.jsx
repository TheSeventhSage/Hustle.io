...
export default function CreateHustleWizard() {
  ...
  return (
    <div className="min-h-screen bg-bg py-8 px-4">
      <div className="max-w-[680px] mx-auto bg-white dark:bg-surface rounded-[24px] shadow-sm border border-border overflow-hidden">
        <div className="flex items-center justify-between px-7 py-5 border-b border-border">
          <h2 className="text-[18px] font-bold text-text-1 font-display">Creae a hustle</h2>
          <button
            onClick={() => navigate(-1)}
